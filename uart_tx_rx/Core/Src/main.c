...
//  char msg[20] = "send message";
//  HAL_UART_Transmit(&huart1, (uint8_t *)msg, strlen(msg), 20);
//  HAL_UART_Receive_IT(&huart1, rxbuf, 26);

  uint8_t rx_data[3];
  uint8_t tx_data[3]  ="hi";
  while (1)
  {
...
//{
//    HAL_UART_Transmit(&huart1, rxbuf, 20, 100);
//    HAL_Delay(1000);
//    HAL_UART_Receive_IT(&huart1, rxbuf, 20);
//}
