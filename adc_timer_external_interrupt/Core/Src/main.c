...
/* code task:
two GPIO are taken as external interrupt 
and one GPIO is taken as output and toggled continuosly
when it is connected to any external GPIO count should be stored
ADC conversion is also runnign in parallel
*/
