...
void ModbusMasterRxCpltCallback(void)
{
    ...
    if (gModbusMasterData.rxPointer == gModbusMasterData.totalRxValue)
    {
        ...
        HAL_UART_Receive_IT(&huart1, gRxBuffer, 11);

}

//1.send modbus frame every 1 second
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef* htim)
{
    if (htim->Instance == TIM2)
    {
           ...
           HAL_UART_Transmit_IT(&huart1, gModbusMasterData.modbusFrame, gModbusMasterData.totalTxValue);
...
//    {
//        // Transmission done, clear busy flag
//        gModbusMasterData.flags.bitValue.busyProcessing = 0;
//
//        // Start reception for response
//        HAL_UART_Receive_IT(&huart1, gRxBuffer, 11);
//    }
//}
